...
// will change
bool out = LOW; // current state of output (whether or not to print)
bool in; // current state of the input (button)
bool prevIn = LOW; // previous state of input

// debounce from https://www.arduino.cc/en/tutorial/debounce
unsigned long lastDebounceTime = 0; // last time the output pin was toggled
unsigned long debounceDelay = 500; // debounce time; increase until led does not flicker
